...
def parse_args():
    ...
    return host, port, community, cload1, cload5, \
        cload15, wload1, wload5, wload15


def get_data():

    host, port, community, cload1, cload5, cload15, \
        wload1, wload5, wload15 = parse_args()
...
def main():
    ...
    if load1 >= cload1 or load5 >= cload5 or load15 >= cload15:
        print('CRITICAL - Load average : %s,%s,%s \
              |load1=%s;load5=%s;load15=%s'

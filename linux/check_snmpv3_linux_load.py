...
def parse_args():
    ...
    return host,port,username,auth_pass,priv_pass,timeout,cload1,cload5,cload15,wload1,wload5,wload15

def get_data():

    host,port,username,auth_pass,priv_pass,timeout,cload1,cload5,cload15,wload1,wload5,wload15 = parse_args()
